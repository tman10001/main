...
print(Back.WHITE + Fore.BLACK + 'Instagram First comment bot, contact me on discord @congoid#2122 for help\n')
print(Fore.RED + 'Paid version of this bot!')
        ...
        try:
            ...
            while i <= total - 1:
                try:
                    ...
                    elif not timeline[i]['comment_count'] == 30:
